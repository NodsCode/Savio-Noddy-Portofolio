        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h3 className="text-2xl font-semibold">
              Passionate Web Developer & Tech 
            </h3>

            <p className="text-muted-foreground">
              I’m a passionate Computer Science student and aspiring front-end developer 
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
              ...
              <a
                href="https://docs.google.com/document/d/18CUnzs2AJ5BH_akOFXrkK9t1phbDbk-w3vFojKoyatY/edit?usp=sharing"
